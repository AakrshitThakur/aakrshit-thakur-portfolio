...
1. Clone this repository:
   ...
   ```bash
   git clone https://github.com/AakrshitThakur/aakrshit-thakur-portfolio.git my-portfolio
   cd aakrshit-thakur-portfolio
   ```
...
3. **Education**: Add your work education in `config/education.ts`
